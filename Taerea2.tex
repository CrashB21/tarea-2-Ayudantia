...
\begin{itemize}[noitemsep, topsep=0pt]
    ...
    \item Amaro Alarcón (aalarconl@usm.cl)
    \item Isaias Morales (imoralesv@usm.cl)
\end{itemize}
...
\begin{lstlisting}[language=C++]
void EliminarInestabilidad(float eMax);
\end{lstlisting}
\begin{itemize}[noitemsep, topsep=0pt]
...
\begin{itemize}[noitemsep, topsep=0pt]
    \item Se evalúa el par \texttt{P006} y \texttt{P003}: $22.1 + 18.4 = 40.5$. Supera el límite de 30.0. Como \texttt{P006} tiene mayor energía (22.1 > 18.4), colapsa y es eliminado. La nueva cabeza pasa a ser \texttt{P003}.
    \item Se evalúa el nuevo par adyacente \texttt{P003} y \texttt{P005}: $18.4 + 15.7 = 34.1$. Supera el límite de 30.0. Como \texttt{P003} tiene mayor energía (18.4 > 15.7), colapsa y es eliminado.
\end{itemize}
